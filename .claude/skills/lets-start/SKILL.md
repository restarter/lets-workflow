...
Run `/lets-beads-status` skill to show full task overview.
...
- Inform user: "Created task yii2-chXX, working in feature branch"
...
After task is selected (e.g., `yii2-ch15` "Fix proxy config"):
...
Examples:
- `feature/yii2-ch15-fix-proxy-config`
- `feature/yii2-ch5-add-mobile-api`
