...
func TestRenderEnv_Golden(t *testing.T) {
	tests := []struct {
		...
		{"default", Prefs{Language: "English", MergeBranch: "main", PRFlow: "local", Tracker: "beads", Launcher: "terminal", RulesScope: "project"}, "testdata/golden_env_default.txt"},
		{"ukrainian", Prefs{Language: "Ukrainian", MergeBranch: "main", PRFlow: "local", Tracker: "beads", Launcher: "terminal", RulesScope: "project"}, "testdata/golden_env_ukrainian.txt"},
		{"github", Prefs{Language: "English", MergeBranch: "main", PRFlow: "github", Tracker: "beads", Launcher: "terminal", RulesScope: "project"}, "testdata/golden_env_github.txt"},
	}
...
func TestRenderEnv_NonEmptyValues(t *testing.T) {
	prefs := Prefs{
		Language: "English", MergeBranch: "main", PRFlow: "local", Tracker: "beads", Launcher: "terminal", RulesScope: "project",
	}
	...
	for _, k := range []string{"LETS_LANGUAGE=", "LETS_MERGE_BRANCH=", "LETS_PR_FLOW=", "LETS_TRACKER=", "LETS_LAUNCHER=", "LETS_RULES_SCOPE="} {
