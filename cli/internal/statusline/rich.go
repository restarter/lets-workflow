...
var tips = []string{
	...
	"/lets:research --workflow runs decompose -> web -> cross-check off-context.",
	"--workflow (review/opinion/backlog/research) moves the heavy fan-out off-context — same result, lighter window.",
